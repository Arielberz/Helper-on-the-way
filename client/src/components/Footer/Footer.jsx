/*
  קובץ זה אחראי על:
  - תצוגת שורת תחתית (Footer) קבועה בכל עמודי האפליקציה
  - קישורים לתנאי שימוש, מדיניות פרטיות, צור קשר
  - מידע על הפרויקט וזכויות יוצרים
  ...
  הקובץ אינו:
  - מכיל לוגיקה או קריאות API
  - מטפל במצב או אינטראקציות משתמש
*/
