    ...
    <div className="space-y-4">
      <div className="flex flex-col" style={{ gap: 'var(--space-md)' }}>
        <label className="flex items-center cursor-pointer transition-colors"
          ...
          />
          <span className="font-medium" style={{ color: 'var(--text-main)' }}>השתמש במיקום GPS שלי</span>
        </label>
        ...
        <label className="flex items-center cursor-pointer transition-colors"
          ...
          <input
            ...
            style={{ accentColor: 'var(--primary)' }}
          />
          <span className="font-medium" style={{ color: 'var(--text-main)' }}>הזן כתובת ידנית</span>
        </label>
      </div>
        ...
        <div className="flex items-center justify-center"
          ...
          {isLoadingLocation ? (
            <div className="flex items-center" style={{ gap: 'var(--space-sm)', color: 'var(--primary)' }}>
              ...
              <span className="font-medium">מאתר...</span>
            </div>
          ) : currentLocation ? (
            ...
            <span style={{ color: 'var(--text-light)' }}>ממתין למיקום...</span>
          )}
        </div>
      )}
